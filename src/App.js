...
import { Grid, Typography, Container, Card, CardContent, CardActions, Button, CardMedia, Paper} from "@material-ui/core";
  ...
  return (
    <>
      ...
      <Container maxWidth="lg" className="content">
        ...
        <Grid container spacing={2} justify="center" alignItems="flex-start" style={{ marginBottom: "1rem"}}>
          <Grid item md={12} lg={4}>
            <Card>
              <CardMedia
                className="card-image"
                image={process.env.PUBLIC_URL + "images/homeautomation.jpg"}
              />
              <CardContent>
          ...
          <Grid item md={12} lg={4}>
            <Card>
              <CardMedia
                className="card-image"
                image={process.env.PUBLIC_URL + "images/weatherstation.jpg"}
              />
              <CardContent>
                <Typography color="textSecondary" gutterBottom>
                  Mein Tüftelprojekt
          ...
          <Grid item md={12} lg={4}>
            <Card>
              <CardMedia
                className="card-image"
                image={process.env.PUBLIC_URL + "images/bookkeeping.jpg"}
              />
              <CardContent>
                <Typography color="textSecondary" gutterBottom>
